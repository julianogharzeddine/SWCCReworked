...
function renderWorklist(data) {
    ...
    data.map((task) => {
        ...
        <div class="worklistItem" data-serial="${taskSerialNo}"> <div class="itemInfoWrapper taskSerialNo"><p class="itemInfoHeading">${langIsAr() ? "SERIAL NO." : "الرقم التسلسلي"}</p><p class="itemInfoData"> <a href="${taskFormURL}" target="_blank">${taskSerialNo}</a> </p></div><div class="itemInfoWrapper taskTitle"> <p class="itemInfoHeading">${langIsAr() ? "TASK TITLE" : "الموضوع"}</p><p class="itemInfoData">${taskActivityName}</p></div><div class="itemInfoWrapper taskStartDate"> <p class="itemInfoHeading">${langIsAr() ? "ASSIGNED" : "التاريخ"}</p><p class="itemInfoData">${taskDate}</p></div><div class="itemInfoWrapper taskProgress"> <p class="itemInfoHeading">${langIsAr() ? "STATUS" : "الحالة"}</p><p class="itemInfoData"></p></div><div class="itemInfoWrapper taskDueDate"> <p class="itemInfoHeading">${langIsAr() ? "DUE DATE" : "تاريخ الإنتهاء"}</p><p class="itemInfoData">${taskDueDate}</p></div><div class="itemInfoWrapper taskActions"> <p class="itemInfoHeading">${langIsAr() ? "ACTIONS" : "الإجراءات"}</p><p class="itemInfoData"> <img src="https://cdn.jsdelivr.net/gh/julianogharzeddine/SWCCIcons@main/release-icon.png" id="release-task" data-serial="${taskSerialNo}" class="action-task" alt="release"> <img src="https://cdn.jsdelivr.net/gh/julianogharzeddine/SWCCIcons@main/sleep-icon.png" id="sleep-task" data-serial="${taskSerialNo}" class="action-task" alt="sleep"> <img src="https://cdn.jsdelivr.net/gh/julianogharzeddine/SWCCIcons@main/redirect-icon.png" id="redirect-task" data-serial="${taskSerialNo}" class="action-task" alt="redirect"> <img src="https://cdn.jsdelivr.net/gh/julianogharzeddine/SWCCIcons@main/share-icon.png" id="share-task" data-serial="${taskSerialNo}" class="action-task" alt="share"></p></div></div>
        `)
    })
